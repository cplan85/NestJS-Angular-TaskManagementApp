...
let UserService = class UserService {
    ...
    async create(newUser) {
        ...
        if (emailExists === false && usernameExists === false) {
            ...
            throw new common_1.HttpException('Email or Username is already taken', common_1.HttpStatus.CONFLICT);
        }
    }
    async login(user) {
        ...
        if (foundUser) {
            ...
            if (passwordMatch === true) {
                ...
                throw new common_1.HttpException('Login not successful, wrong credentials', common_1.HttpStatus.UNAUTHORIZED);
            }
        }
        else {
